                  ...
                  <Card key={index} className="hover:shadow-lg transition-shadow">
                     <CardContent className="pt-6">
                        <div className="flex gap-4">
                           ...
                           <div className="aspect-square bg-muted rounded-lg flex items-center justify-center flex-shrink-0 overflow-hidden" style={{ height: 'fit-content', alignSelf: 'stretch' }}>
